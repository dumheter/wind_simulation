...
void MicroProfilePrintf(MicroProfileWriteCallback CB, void *Handle,
  ...
  int size = stbsp_vsprintfcb((STBSP_SPRINTFCB *)MicroProfilePrintfCallback,
                              (void *)&A, Buffer, pFmt, args);
  (void)size;
  va_end(args);
}
...
void MicroProfileWSPrintf(const char *pFmt, ...) {
  ...
  stbsp_vsprintfcb((STBSP_SPRINTFCB *)MicroProfileWSPrintfCallback, 0,
